...
![Owner-provided Review overview and weekly volume screenshot](../media/review-overview.png)

![Owner-provided Back Squat strength progress screenshot](../media/strength-progress.png)

## 4. Personalize

Choose the theme, spacing, text size and accent colour in Settings.

![Owner-provided appearance settings screenshot](../media/appearance-settings.png)
